                ...
                .map(
                  (participant) => `
                    <li>
                      ...
                      <button class="delete-participant" type="button" data-activity="${name}" data-email="${participant}" aria-label="Remover ${participant}" title="Remover participante">&#128465;</button>
                    </li>`
                )
                .join("")}
            </ul>`
